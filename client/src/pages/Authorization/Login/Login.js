...
import { loginAction as _loginAction } from "$store/actions/user";
...
function Login({ loginAction, isLoading, errorText }) {
  const { onChange, onSubmit, values, errors, onBlur } = useLoginForm({
...
export default connect(mapStateToProps, { loginAction: _loginAction })(Login);
